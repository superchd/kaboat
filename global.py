...
def cmd_l(optimal):
    if 10 < optimal <= 30:
        motor.motor_move(-18,-30)
        print("left1")
    elif 30 < optimal <= 60:
        motor.motor_move(-15,-25)
        print("left2")
    elif 60 < optimal <= 80:
        motor.motor_move(-17,-22)
        print("left3")
    elif 80 < optimal <= 90:
        motor.motor_move(-0,-30)
        print("meet wall go left")
    elif 0 < optimal <= 10:
        motor.motor_move(-20,-20)
        print("go straight")
...
def cmd_r(optimal):
    if 0 < optimal <= 10:
        ...
        print("wall meet go right please")
    elif 10 < optimal <=30:
        motor.motor_move(-30,-18)
    elif 30 < optimal <= 60:
        motor.motor_move(-25,-15)
        print("right2")
    elif 60 < optimal <= 80:
        motor.motor_move(-22,-17)
        print("right3")
