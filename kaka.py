...
def cmd_l(optimal):
    if 10 < optimal <= 30:
        motor.motor_move(-21.6,-36)
        print("left1")
    elif 30 < optimal <= 60:
        motor.motor_move(-18,-28)
        print("left2")
    elif 60 < optimal <= 90:
        motor.motor_move(-20.4,-26.4)
        print("left3")
    elif 0 < optimal <= 10:
        motor.motor_move(-24,-24)
        print("go straight")
...
def cmd_r(optimal):
    if 0 < optimal <= 30:
        motor.motor_move(-36,-21.6)
        print("right1")
    elif 30 < optimal <= 60:
        motor.motor_move(-28,-18)
        print("right2")
    elif 60 < optimal <= 80:
        motor.motor_move(-26.4,-20.4)
        print("right3")
